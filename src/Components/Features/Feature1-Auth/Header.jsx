...
const Header = ({ title, subtitle }) => {
  return (
    <div className="flex flex-col items-center w-full text-center pt-[24px]">
      ...
      {/* 3. النص الفرعي  */}
      <p className="font-tajawal font-normal text-[16px] leading-[24px] tracking-normal text-center align-middle text-[#4C2325]">
        {subtitle} 
      </p>
