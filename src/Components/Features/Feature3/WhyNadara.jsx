    ...
    const features = [
        {
            ...
            description:
                "اختر الخدمة والطبيب والوقت المتاح فعلياً، واحصل على تأكيد من إدارة العيادة دون اتصالات هاتفية.",
        },
        {
            icon: FaCreditCard,
            title: "دفع بسيط وموثّق",
            description:
                "حوّل قيمة الجلسة عبر البنك أو المحفظة وارفع الإيصال، ويبقى رقم إيصالك محفوظاً في حسابك.",
        },
        {
            icon: FaComments,
